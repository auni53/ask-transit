...
describe('class Client', () => {
  ...
  it('constructs a new Transit Client', function() {
    //(new Client()).should.be.a('Client');
  });

  it('loads data for an agency', function() {
    // assert.throws(() => new Client('foobar'), Error, 'agency not found');
  });

  it('should load routes for the agency', function() {
    /*
